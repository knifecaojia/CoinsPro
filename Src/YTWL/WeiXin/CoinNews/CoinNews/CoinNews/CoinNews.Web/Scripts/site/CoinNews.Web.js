...
(function (CoinNews) {
    ...
    })(Administration = CoinNews.Administration || (CoinNews.Administration = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Administration;
...
(function (CoinNews) {
    ...
    })(BasicSamples = CoinNews.BasicSamples || (CoinNews.BasicSamples = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CoinNews.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = CoinNews.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CoinNews.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (CoinNews) {
    ...
    })(Common = CoinNews.Common || (CoinNews.Common = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Common;
...
(function (CoinNews) {
    ...
    })(Membership = CoinNews.Membership || (CoinNews.Membership = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Membership;
...
(function (CoinNews) {
    ...
    })(Northwind = CoinNews.Northwind || (CoinNews.Northwind = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Northwind;
...
(function (CoinNews) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'CoinNews.Northwind.Gender', 'CoinNews.Northwind.Entities.Gender');
    })(Northwind = CoinNews.Northwind || (CoinNews.Northwind = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
...
(function (CoinNews) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = CoinNews.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = CoinNews.LanguageList || (CoinNews.LanguageList = {}));
})(CoinNews || (CoinNews = {}));
...
(function (CoinNews) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('CoinNews');
        Serenity.EntityDialog.defaultLanguageList = CoinNews.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = CoinNews.ScriptInitialization || (CoinNews.ScriptInitialization = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Administration;
...
(function (CoinNews) {
    ...
    CoinNews.BasicProgressDialog = BasicProgressDialog;
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new CoinNews.BasicProgressDialog();
...
(function (CoinNews) {
    ...
    })(DialogUtils = CoinNews.DialogUtils || (CoinNews.DialogUtils = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Common;
...
(function (CoinNews) {
    ...
    CoinNews.StaticTextBlock = StaticTextBlock;
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                CoinNews.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(CoinNews.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(CoinNews.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(CoinNews.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        CoinNews.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: CoinNews.Authorization.userDefinition.DisplayName,
...
(function (CoinNews) {
    ...
    (function (Northwind) {
        ...
        }(CoinNews.Common.GridEditorDialog));
...
(function (CoinNews) {
    ...
    (function (Northwind) {
        ...
        }(CoinNews.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return CoinNews.LanguageList.getValue();
            };
...
(function (CoinNews) {
    ...
    })(Authorization = CoinNews.Authorization || (CoinNews.Authorization = {}));
})(CoinNews || (CoinNews = {}));
var CoinNews;
(function (CoinNews) {
    var BasicSamples;
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.ProductDialog));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: CoinNews.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: CoinNews.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new CoinNews.Northwind.OrderDialog();
                        ...
                        var chai = CoinNews.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = CoinNews.Northwind.EmployeeRow.getLookup().items
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.OrderDialog));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    CoinNews.Northwind.CategoryService.Retrieve({
        ...
        }(CoinNews.Northwind.CategoryDialog));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(CoinNews.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new CoinNews.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                CoinNews.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(CoinNews.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    CoinNews.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(CoinNews.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(CoinNews.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    CoinNews.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return CoinNews.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return CoinNews.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return CoinNews.Northwind.OrderService.baseUrl; };
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.SupplierDialog));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(CoinNews.Northwind.SupplierGrid));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return CoinNews.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return CoinNews.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return CoinNews.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return CoinNews.Northwind.OrderService.baseUrl; };
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    CoinNews.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(CoinNews.Northwind.CustomerDialog));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = CoinNews.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return CoinNews.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new CoinNews.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(CoinNews.Northwind.OrderDetailDialog));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Northwind.OrderDetailsEditor));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return CoinNews.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return CoinNews.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return CoinNews.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return CoinNews.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        ...
        }(CoinNews.Common.BulkServiceAction));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return CoinNews.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return CoinNews.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return CoinNews.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(CoinNews.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new CoinNews.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new CoinNews.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new CoinNews.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (CoinNews) {
    ...
    CoinNews.SelectableEntityGrid = SelectableEntityGrid;
})(CoinNews || (CoinNews = {}));
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return CoinNews.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return CoinNews.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return CoinNews.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(CoinNews.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = CoinNews.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            CoinNews.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return CoinNews.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return CoinNews.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return CoinNews.Northwind.ProductService.baseUrl; };
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return CoinNews.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return CoinNews.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return CoinNews.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return CoinNews.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (CoinNews) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return CoinNews.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return CoinNews.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return CoinNews.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=CoinNews.Web.js.map