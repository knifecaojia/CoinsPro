    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your CoinNews Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your CoinNews Account";
                    ...
                    public static LocalText FormTitle = "Sign up for CoinNews";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "CoinNews";
        }
