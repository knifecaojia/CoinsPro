//请求地址(列表)
var RequestListUrl = "/News_type/GetNews_typeList";
//请求地址(单条记录)
var RequestUrl = "/News_type/GetNews_type";
//请求地址(删除记录)
var RequestDelUrl = "/News_type/DelNews_type";
//请求地址(修改)
var RequestEditUrl = "News_type/EditNews_type";
//请求控制器(添加)
var RequestAddUrl = "News_type/AddNews_type"
