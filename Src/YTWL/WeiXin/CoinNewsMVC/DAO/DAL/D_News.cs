...
namespace DAO.DAL
{
	...
	public class D_News:INews
	{
		...
		/// 增加一条数据
		/// </summary>
		public virtual object  Save(News model)
		{
			using (ISession session = sessionFactory.OpenSession())
            {
		...
		/// 更新一条数据
		/// </summary>
		public virtual void Update(News model)
		{
		...
		public virtual void Delete(object id)
		{
			using (var session = sessionFactory.OpenSession())
            {
                var model = session.Load<News>(id);
		...
		/// 删除数据
		/// </summary>
		public virtual void Delete(News model)
		{
			using (var session = sessionFactory.OpenSession())
            {
                session.Delete(model);
		...
		/// 得到一个对象实体
		/// </summary>
		public virtual News Get(object id)
		{
			using (ISession session = sessionFactory.OpenSession())
            {
		...
		/// 获得数据列表
		/// </summary>
		public virtual IList<News> LoadAll()
		{
			using (ISession session = sessionFactory.OpenSession())
            {
		...
		/// 获得前几行数据
		/// </summary>
		public virtual IList<News>  GetList(List<SearchTemplate> st, List<Order> order)
		{
			using (ISession session = sessionFactory.OpenSession())
            {
