//请求地址(列表)
var RequestListUrl = "/Diction/GetOrganization_typeList";
//请求地址(单条记录)
var RequestUrl = "/Diction/GetOrganization_type";
//请求地址(删除记录)
var RequestDelUrl = "/Diction/DelOrganization_type";
//请求地址(修改)
var RequestEditUrl = "/Diction/EditOrganization_type";
//请求控制器(添加)
var RequestAddUrl = "/Diction/AddOrganization_type"
    ...
    oInit.Init = function () {
        ...
        $("#btn_edit").click(function () {
            ...
            $.post(RequestUrl, { id: arrselections[0].id }, function (data) {
                $("#id").val(data.id);
                $("#txt_name").val(data.orgtype_name);
