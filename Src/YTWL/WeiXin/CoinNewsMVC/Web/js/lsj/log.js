//请求地址(列表)
var RequestListUrl = "/Log/GetlogList";
//请求地址(单条记录)
var RequestUrl = "/Log/Getlog";
//请求地址(删除记录)
var RequestDelUrl = "/Log/Dellog";
//请求地址(修改)
var RequestEditUrl = "/Log/EditGetlog";
//请求控制器(添加)
var RequestAddUrl = "/Log/AddGetlog"
