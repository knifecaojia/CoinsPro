...
namespace KFCC.ExchangeInterface
{
    ...
    public interface IExchanges
    {
       ...
       // bool SportWSS { get; set; }
        ...
        /// <returns></returns>
        CommonLab.Ticker GetTicker(string tradingpair,ref string rawresponse);
        /// <summary>
        /// 获取市场depth信息
        /// </summary>
        /// <param name="tradingpair"></param>
        /// <returns></returns>
        CommonLab.Depth GetDepth(string tradingpair, ref string rawresponse);
        /// <summary>
        /// 通过交易对获取公开市场信息api的url 主要用于GET方式取得数据资源
        /// </summary>
        /// <param name="tradingpair"></param>
        /// <returns></returns>
        string GetPublicApiURL(string tradingpair);
        #endregion
    }
}
