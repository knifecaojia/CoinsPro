...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            KFCC.ExchangeInterface.IExchanges exchange = new KFCC.EHuobiExchange.HuobiExchange("cbf0909f-7842f68b-8c0db43c-04172", "7e022c00-19e4e4a8-2b3ed1d9-312e0", "0", "caojia");
            exchange.GetAccount(out raw);
